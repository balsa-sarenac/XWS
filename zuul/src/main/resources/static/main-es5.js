    ...
    var CarService = /*#__PURE__*/function () {
      ...
      _createClass(CarService, [{
        ...
        value: function getCarsByUser() {
          return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].api + "/car/car/user"); //return this.http.get<any>("http://localhost:8083/car/user");
        }
      }, {
        key: "getOneAd",
