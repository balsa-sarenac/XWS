...
insert into PRICE_LIST (per_day, extra_kilometrage, cdw, discount, discount_days) values (7, 4, 10, 10, 20);
insert into PRICE_LIST (per_day, extra_kilometrage, cdw, discount, discount_days) values (8, 6, 150, 11, 30);
insert into PRICE_LIST (per_day, extra_kilometrage, cdw, discount, discount_days) values (9, 5, 100, 12, 20);
insert into PRICE_LIST (per_day, extra_kilometrage, cdw, discount, discount_days) values (11, 6, 200, 10, 25);
